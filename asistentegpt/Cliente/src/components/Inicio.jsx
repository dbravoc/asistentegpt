        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-left">
            <div className="relative rounded-full px-6 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20">
              Asistentes legales virtuales y abogados expertos .{' '}
          ...
          <div className="text-left px-0">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Asistencia jurídica laboral con inteligencia artificial y abogados expertos
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
            Accede fácilmente a asesoría legal con nuestros asistentes virtuales y abogados especializados para tus demandas.
            </p>
            <div className="mt-10 flex items-center justify-left gap-x-6">
              ...
              <a href="#" className="text-sm font-semibold leading-6 text-gray-900">
                O con un asistente virtual <span aria-hidden="true">→</span>
              </a>
            </div>
          </div>
        </div>
